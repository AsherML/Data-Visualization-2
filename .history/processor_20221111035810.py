...
for s in range(numStates):
    if toDf['state'][s] in toDf['county']:
        ind=toDf['county'].index(toDf['state'][s])
        toDf['numDevelopers'][ind]+=toDf['numDevelopers'][s]
    else:
        toDf['county'].append(toDf['state'][s])
        toDf['state'].append(toDf['state'][s])
        toDf['numDevelopers'].append(toDf['numDevelopers'][s])
